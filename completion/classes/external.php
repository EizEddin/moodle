...
class core_completion_external extends external_api {
     ...
     * @return boolean
     */
    public static function override_activity_completion_status_is_allowed_from_ajax() {
        return true;
    }
    ...
    public static function override_activity_completion_status_returns() {
        ...
        return new external_single_structure(
			...
			'Status, true if success'),
                'warnings'	=> new external_warnings(),
		'changecompl'	=> new external_value(PARAM_ALPHANUMEXT,
			'The new completion change data'),
		'img'		=> new external_value(PARAM_RAW,
			'Image element to replace existing one'),
            )
        );
    }
